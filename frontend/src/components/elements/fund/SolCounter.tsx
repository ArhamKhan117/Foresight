...
const SolCounter = ({ setAmount, amount }: SolCounterProps) => {
  ...
  return (
    <div className="self-stretch p-2 bg-[#111111] rounded-xl shadow-[inset_0px_2px_0px_0px_rgba(0,0,0,0.20)] outline-1 outline-offset-[-1px] outline-[#313131] inline-flex justify-start items-center gap-3 select-none">
      {/* Decrease Button */}
      <div
